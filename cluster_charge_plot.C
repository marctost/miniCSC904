...
TGraph* make_graph(string norm_or_no, int i, PlotterLines run_0, PlotterLines run_1, PlotterLines run_2, PlotterLines run_3, PlotterLines run_4){
    ...
    // This takes car of the values that are not measured. Should not need to be used again.
    for (int g=0;g<12;g++){
        if (run_1.lines[0].at(g)==0){
            run_1.lines[0].at(g)= run_0.lines[0].at(g);
        }
    }
...
int graph_section(string filename, string norm_or_no, PlotterLines hole_num, PlotterLines run_0, PlotterLines run_1, PlotterLines run_2, PlotterLines run_3, PlotterLines run_4){
    ...
    Color_t colors[] = {kRed, kRed+3, kRed-6, kOrange-3, kBlue-6, kGreen, kGreen-1, kBlue, kYellow, kCyan, kBlack, kMagenta};
    ...
    TGraph* graph_1_1 = make_graph(norm_or_no,0,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_1_2 = make_graph(norm_or_no,1,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_2_1 = make_graph(norm_or_no,2,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_2_2 = make_graph(norm_or_no,3,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_3_1 = make_graph(norm_or_no,4,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_3_2 = make_graph(norm_or_no,5,run_0, run_1, run_2, run_3, run_4);
    
    TGraph* graph_bot_1_1 = make_graph(norm_or_no,6,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_bot_1_2 = make_graph(norm_or_no,7,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_bot_2_1 = make_graph(norm_or_no,8,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_bot_2_2 = make_graph(norm_or_no,9,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_bot_3_1 = make_graph(norm_or_no,10,run_0, run_1, run_2, run_3, run_4);
    TGraph* graph_bot_3_2 = make_graph(norm_or_no,11,run_0, run_1, run_2, run_3, run_4);
    ...
    legend->AddEntry(fin_graph_1_1, "Irr (1,1)");
    legend->AddEntry(fin_graph_1_2, "Irr (1,2)");
    legend->AddEntry(fin_graph_2_1, "Irr (2,1)");
    legend->AddEntry(fin_graph_2_2, "Irr (2,2)");
    legend->AddEntry(fin_graph_3_1, "Irr (3,1)");
    legend->AddEntry(fin_graph_3_2, "Irr (3,2)");
    
    legend->AddEntry(fin_graph_bot_1_1, "Ref (1,1)");
    legend->AddEntry(fin_graph_bot_1_2, "Ref (1,2)");
    legend->AddEntry(fin_graph_bot_2_1, "Ref (2,1)");
    legend->AddEntry(fin_graph_bot_2_2, "Ref (2,2)");
    legend->AddEntry(fin_graph_bot_3_1, "Ref (3,1)");
    legend->AddEntry(fin_graph_bot_3_2, "Ref (3,2)");
